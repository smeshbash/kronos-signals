"""
Full MFE/MAE + TP/SL grid analysis for kronos-base 1H across all assets.
"""
import sqlite3, sys
...
for symbol in ASSETS:
    ...
    print()
    print(f"  {'#':>2}  {'Dir':5}  {'MFE%':>6}  {'MAE%':>6}  {'Cap%':>6}  "
    ...
    if best_pos:
        ...
        print(f"  Top-5 profitable (closest to current TP=1.0x SL=1.5x):")
